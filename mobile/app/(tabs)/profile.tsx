      ...
      >
        ...
        <View className="px-4 pb-4 border-b border-gray-100">
          ...
          <View className="mb-4">
            ...
            <Text className="text-gray-900 mb-3">{currentUser.bio || "Tell us about yourself"}</Text>

            <View className="flex-row items-center mb-2">
              <Feather name="map-pin" size={16} color="#657786" />
              <Text className="text-gray-500 ml-2">{currentUser.location || "No location"}      </Text>
            </View>

            <View className="flex-row items-center mb-3">
              <Feather name="calendar" size={16} color="#657786" />
              <Text className="text-gray-500 ml-2">
                Joined {format(new Date(currentUser.createdAt), "MMMM yyyy")}   </Text>
            </View>
